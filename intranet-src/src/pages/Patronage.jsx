              ...
              <tbody>
                {events.map((e, i) => (
                  <tr key={e.id} style={i % 2 === 0 ? styles.trEven : styles.trOdd}>
                    ...
                    <td style={{ ...styles.td, fontWeight: 600, color: parseFloat(e.amount) >= 0 ? '#4a5f4a' : '#c46a6a' }}>
...
const styles = {
  ...
  csvBtn: {
    ...
    color: 'var(--ember, #c2512a)', borderRadius: '6px', cursor: 'pointer', fontSize: '0.875rem',
  },
  formulaBar: {
    fontSize: '0.8rem', color: 'var(--color-text-muted, #888)',
    padding: '0.5rem 0.75rem', background: 'rgba(194,81,42,0.06)',
    border: '1px solid rgba(194,81,42,0.15)', borderRadius: '6px', marginBottom: '1.25rem',
  },
  ...
  filterBtnActive: {
    background: 'rgba(194,81,42,0.15)', border: '1px solid rgba(194,81,42,0.4)',
  ...
  emptyNotice: {
    padding: '1.5rem', background: 'rgba(194,81,42,0.06)', border: '1px solid rgba(194,81,42,0.15)',
