...
const styles = {
  ...
  sidebarTitle: { fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-muted)', marginBottom: '1rem', paddingLeft: '0.5rem' },
  ...
  docBtnActive: { background: 'var(--gold-12)' },
  docBtnTitle: { fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-page)', marginBottom: '0.1rem' },
  docBtnSub: { fontSize: '0.72rem', color: 'var(--text-muted)' },
  tocSection: { borderTop: '1px solid #2a2a35', paddingTop: '1rem' },
  tocLabel: { fontSize: '0.68rem', textTransform: 'uppercase', letterSpacing: '0.07em', color: 'var(--text-muted)', marginBottom: '0.5rem', paddingLeft: '0.5rem' },
  tocLink: { display: 'block', color: 'var(--text-muted)', textDecoration: 'none', padding: '0.2rem 0.5rem', borderRadius: '4px', lineHeight: 1.4 },
  ...
  placeholderText: { color: 'var(--text-soft)', fontSize: '0.9rem', lineHeight: 1.6, marginBottom: '2rem', maxWidth: '480px' },
  ...
  docCardTitle: { fontSize: '0.95rem', fontWeight: 600, color: 'var(--text-page)', marginBottom: '0.25rem' },
  docCardSub: { fontSize: '0.78rem', color: 'var(--text-muted)', lineHeight: 1.4 },
  ...
  docSubtitle: { color: 'var(--text-muted)', fontSize: '0.875rem', margin: 0 },
  searchInput: {
    padding: '0.5rem 0.75rem', background: 'var(--surface)', border: '1px solid #2a2a35',
    color: 'var(--text-page)', borderRadius: '6px', fontSize: '0.8rem', outline: 'none', width: '180px',
  },
  loading: { color: 'var(--text-muted)', fontSize: '0.875rem' },
  error: { padding: '1rem', background: 'rgba(220,60,60,0.1)', border: '1px solid rgba(220,60,60,0.3)', borderRadius: '8px', color: 'var(--status-err)', fontSize: '0.875rem' },
  mdBody: {
    fontSize: '0.9rem', lineHeight: 1.8, color: 'var(--text-ccc)',
  },
}
