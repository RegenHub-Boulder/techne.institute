...
const styles = {
  ...
  tabActive: { color: 'var(--color-copper, #c87533)', borderBottom: '2px solid var(--color-copper, #c87533)', fontWeight: 600 },
  tabContent: {
  ...
  submitBtn: {
    background: 'var(--color-copper, #c87533)', border: 'none', color: '#fff',
  ...
  backLink: { fontSize: '0.875rem', color: 'var(--color-copper, #c87533)', textDecoration: 'none' },
