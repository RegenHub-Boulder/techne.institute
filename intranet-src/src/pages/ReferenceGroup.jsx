...
function GuideTab() {
  ...
  function highlight(html) {
    ...
    return html.replace(
      new RegExp(`(${esc})`, 'gi'),
      '<mark style="background:rgba(200,117,51,0.3);color:inherit">$1</mark>'
    )
  }
      ...
      {!loading && docs.length === 0 && (
        <div style={d.emptyCard}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#888', margin: 0 }}>
            ...
            <a href="mailto:steward@techne.studio" style={{ color: '#c87533', textDecoration: 'none' }}>
              Contact a steward
            </a>
            .
          </p>
...
const g = {
  ...
  docBtnActive: { background: 'rgba(200,117,51,0.1)' },
...
const d = {
  ...
  docIcon: {
    ...
    background: 'rgba(200,117,51,0.12)', color: '#c87533',
  ...
  downloadBtn: {
    padding: '0.4rem 0.85rem', background: '#c87533',
  ...
  infoBox: {
    ...
    background: 'rgba(200,117,51,0.05)', border: '1px solid rgba(200,117,51,0.12)',
    borderRadius: 8,
  },
