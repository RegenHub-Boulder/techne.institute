...
export default function FinanceGroup({ initialTab = 'overview' }) {
  ...
  const tabs = [
    ...
    ...(isSteward ? [{ key: 'treasury', label: 'Treasury', badge: 'S', badgeColor: '#c87533' }] : []),
  ]
...
const CATEGORY_COLOR = {
  income: '#4caf82', expense: '#ff6b6b', capital_call: '#c87533',
...
const s = {
  ...
  emptyNotice: {
    padding: '1.5rem', background: 'rgba(200,117,51,0.05)',
    border: '1px solid rgba(200,117,51,0.12)', borderRadius: 8,
