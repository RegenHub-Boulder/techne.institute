...
const styles = {
  ...
  error: { padding: '1rem', background: 'rgba(196,80,80,0.1)', border: '1px solid rgba(196,80,80,0.3)', borderRadius: '8px', color: '#c46a6a', fontSize: '0.875rem', marginBottom: '1rem' },
  ...
  fmvPreview: { background: 'rgba(194,81,42,0.08)', border: '1px solid rgba(194,81,42,0.2)', borderRadius: '6px', padding: '0.65rem 1rem', fontSize: '0.85rem', color: '#ccc', marginBottom: '1rem' },
  ...
  submitBtn: { background: 'var(--ember, #c2512a)', border: 'none', color: '#fff', borderRadius: '6px', padding: '0.5rem 1rem', fontSize: '0.875rem', fontWeight: 600, cursor: 'pointer' },
}
