...
const styles = {
  ...
  summaryCard: { background: 'var(--surface)', border: '1px solid #2a2a35', borderRadius: '10px', padding: '1.25rem 1.5rem', minWidth: '140px' },
  summaryCardSmall: { padding: '1rem 1.25rem', minWidth: '120px' },
  summaryLabel: { fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.06em', color: 'var(--text-muted)', marginBottom: '0.4rem' },
  summaryValue: { fontSize: '1.75rem', fontWeight: 700, letterSpacing: '-0.02em' },
  summaryValueSmall: { fontSize: '1.25rem', fontWeight: 700 },
  summaryUnit: { fontSize: '0.875rem', fontWeight: 400, color: 'var(--text-muted)' },
  filters: { marginBottom: '1rem' },
  select: { background: 'var(--surface)', border: '1px solid #2a2a35', color: 'var(--text-page)', borderRadius: '6px', padding: '0.4rem 0.75rem', fontSize: '0.8rem', cursor: 'pointer' },
  empty: { padding: '2rem', textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.875rem', background: 'var(--surface)', borderRadius: '10px', border: '1px solid #2a2a35', lineHeight: 1.6 },
  table: { background: 'var(--surface)', border: '1px solid #2a2a35', borderRadius: '10px', overflow: 'hidden' },
  tableHead: {
  ...
  cellDate: { color: 'var(--text-muted)', fontSize: '0.8rem' },
  cellMuted: { color: 'var(--text-soft)', fontSize: '0.8rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  cellDesc: { color: 'var(--text-ccc)', fontSize: '0.8rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', paddingRight: '0.5rem' },
  typeBadge: { fontSize: '0.72rem', fontWeight: 500, color: 'var(--text-soft)' },
  ...
  modal: { background: 'var(--surface)', border: '1px solid #2a2a35', borderRadius: '12px', padding: '2rem', width: '100%', maxWidth: '480px', margin: '1rem', maxHeight: '90vh', overflowY: 'auto' },
  modalTitle: { fontSize: '1.2rem', fontWeight: 700, marginBottom: '1.5rem' },
  formRow: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  formField: { display: 'flex', flexDirection: 'column' },
  label: { display: 'block', fontSize: '0.78rem', color: 'var(--text-muted)', marginBottom: '0.4rem', textTransform: 'uppercase', letterSpacing: '0.05em' },
  input: { width: '100%', padding: '0.65rem 0.9rem', background: 'var(--app-bg)', border: '1px solid #2a2a35', color: 'var(--text-page)', borderRadius: '6px', fontSize: '0.875rem', marginBottom: '1rem', boxSizing: 'border-box', outline: 'none' },
