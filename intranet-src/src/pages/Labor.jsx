...
const styles = {
  ...
  fmvPreview: { background: 'rgba(196,149,106,0.08)', border: '1px solid rgba(196,149,106,0.2)', borderRadius: '6px', padding: '0.65rem 1rem', fontSize: '0.85rem', color: '#ccc', marginBottom: '1rem' },
