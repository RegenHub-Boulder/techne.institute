...
const styles = {
  ...
  subtitle: { fontSize: '1rem', color: 'var(--text-muted)', margin: '0 0 2rem', lineHeight: 1.6 },
  link: { color: 'var(--gold)', textDecoration: 'none' },
  faqList: { display: 'flex', flexDirection: 'column', gap: '0.5rem' },
  faqItem: {
    background: 'var(--surface)',
    border: '1px solid var(--border-mid)', borderRadius: '8px', overflow: 'hidden',
  },
  faqQ: {
  ...
  arrow: { fontSize: '1.2rem', color: 'var(--gold)', flexShrink: 0, transition: 'transform 0.15s' },
  faqA: {
    padding: '0 1.25rem 1rem', fontSize: '0.9rem', color: 'var(--text-muted)',
    lineHeight: 1.65, borderTop: '1px solid var(--border-mid)',
    paddingTop: '0.875rem',
  },
}
