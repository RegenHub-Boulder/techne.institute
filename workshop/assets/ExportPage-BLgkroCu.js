import{r as m,j as e}from"./vendor-react-DgeyD02N.js";import{B as p}from"./Button-DhYm14Pm.js";import{C as x}from"./Card-BoP7-Vck.js";import{I as f}from"./Input-DfgGg4ED.js";import{u as O}from"./usePageTitle-s-fm6qh5.js";import{Y as S,F as E,ao as D,u as M,v as F}from"./vendor-icons-CYr8Tc6O.js";import"./index-BfG-Uzvc.js";import"./vendor-supabase-BZ0N5lZN.js";const R={id:"json",name:"JSON",mimeType:"application/json",extension:"json",description:"JavaScript Object Notation - structured data format",serializer:(t,r)=>r?.pretty?JSON.stringify(t,null,2):JSON.stringify(t)},$={id:"csv",name:"CSV",mimeType:"text/csv",extension:"csv",description:"Comma-Separated Values - tabular data format",serializer:(t,r)=>{if(!Array.isArray(t)||t.length===0)return"";const n=Object.keys(t[0]),a=[n.join(",")];return t.forEach(c=>{const h=n.map(d=>{const l=c[d];return typeof l=="string"&&(l.includes(",")||l.includes('"'))?`"${l.replace(/"/g,'""')}"`:l??""});a.push(h.join(","))}),a.join(`
